...
//Takes in two doubles and returns a double. This function is the same as 
the one learned in AMTH 108. */
...
listed in the Lab #1 handout. Each and every given calculated quantity (except those given 
